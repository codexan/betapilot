-- Location: supabase/migrations/20250827155354_apply_email_templates_fix.sql
-- Schema Analysis: Fix missing email templates tables
-- Action Type: NEW MODULE - Apply missing email template migration
...
-- 7. RLS Policies using Pattern 2 (Simple User Ownership) and Pattern 6A (Admin Access)
...
-- 8. Triggers for automatic version creation and updated_at
...
-- 9. Mock Data for Email Templates
DO $$
DECLARE
    admin_user_id UUID;
